//               В C#,  ФУНКЦИЯ == МЕТОД .
//
//          Второй способ решения Задачи Task_4
...
// Метод склеивает элементы переданного массива в одну строку
// Пример: [2, 7, 4] => 274

string paste_togetherArray(int[] array)
{
    string glue_number = "";
    for (int i = 0; i < array.Length; i++)
    {
        glue_number += array[i].ToString();
    }
    return glue_number;
}
